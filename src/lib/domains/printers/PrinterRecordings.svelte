<script lang="ts">
	...
	function fileUrl(name: string): string {
		return resolve('/printers/[id]/recordings/[name]', { id, name });
	}
					...
					<div class="rec-meta">
						...
						<div class="rec-meta-row">
							...
							<div class="file-actions">
								<a
									class="btn-icon"
									href={resolve('/printers/[id]/recordings/[name]', { id, name: r.name })}
	...
	{#if playing}
		<div class="rec-player">
			...
			<div class="rec-player-actions">
				<a
					class="btn-inline"
					href={resolve('/printers/[id]/recordings/[name]', { id, name: playing.name })}
